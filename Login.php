    ...
    <form action="postlogin.php" method="post" onsubmit="return check()">
        <table align="center" border="1" style="border-collapse: collapse" cellpadding="10" cellspacing="0">
            ...
            <tr>
                ...
                <td align="left">
                    <label><input name="username" id="username" onblur="checkUsername()"></label>
                    <img src="image/x0.png" id="x0" class="none" alt="">
                    <img src="image/x1.png" id="x1" class="none" alt="">
               <!--我就是一个没用的说明-->
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <input name="code" placeholder="请输入图片中的验证码"><img style="cursor: pointer" src="code.php"
                                                                               onclick="this.src='code.php?'+new Date().getTime();"
                                                                               width="200" height="70">
                    </label>
                    <!--做一点击一次更新一次的请求,加上一个请求时间参数-->
                    <!-- new Date().getTime()得到的是毫秒数-->
                    <!--光标等于手形style="cursor: pointer-->
                    <span class="red">*</span>
                </td>
            </tr>
            <tr>
